...
<!-- ハンバーガーメニューの作成 -->
      ...
      <v-btn v-if="isLoggedIn" light class="ma-2" elevation="0" v-on:click="signOut">ログアウト</v-btn>
      <v-btn v-else light class="ma-2" elevation="0" :to="'/login'">ログイン</v-btn>
      <v-btn light class="ma-2" elevation="0" :to="'/profile'">プロフィール</v-btn>
     ...
     <!-- footer -->
      ...
      class="lighten-2 py-4 text-center white--text"
       ...
       <div class="text-center">
        {{ new Date().getFullYear() }} — <strong>法政Navi
        </strong>
       </div>
  </v-footer>
